...
namespace Acervo_Leitor.Controllers
{
    public class TurmasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,AnoLetivo,Ativa")] Turma turma)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,AnoLetivo,Ativa")] Turma turma)
        {
            if (id != turma.Id)
            {
                return NotFound();
