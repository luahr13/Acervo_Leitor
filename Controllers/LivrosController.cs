...
namespace Acervo_Leitor.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Autor,ISBN,CodigoExemplar,Ativo")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Autor,ISBN,CodigoExemplar,Ativo")] Livro livro)
        {
            if (id != livro.Id)
            {
                return NotFound();
